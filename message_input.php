...
<body>
  ...
  <script>
    ...
    $(function() {
      const classes = [
          {name: 'タロ先生', photo_code: 'img/photo_taro.jpg'},
          {name: 'まっちゃん', photo_code: 'img/photo_mat.jpg'},
          {name: 'かのみ', photo_code: 'img/photo_kanomi.jpg'},
          {name: 'あずあず', photo_code: 'img/photo_azu.jpg'},
        ];
